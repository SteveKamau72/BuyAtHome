...
public class Laptops extends ActionBarActivity {

    private static final String TAG = MainActivity.class.getSimpleName();

    // Movies json url
    private static final String url = "http://softtech.comuv.com/buyathome/laptops.js";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolBarTextView.setText("Laptops");
    ...
    private void requestLaptops() {
      ...
      /*  gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Laptops.this, Details.class);
    ...
    private void serverDialog() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(Laptops.this);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_laptops, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_search) {
            Intent i = new Intent(Laptops.this, SearchActivity.class);
            startActivity(i);
        }
