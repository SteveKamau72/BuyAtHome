 ...
 */
public class LaptopsFragment extends Fragment implements OnOptionsSelectedInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        prices = new String[]{"None", "Below 20,000", "20,000 - 40,000", "40,000 - 80,000", "Above 80,000"};
    ...
    private void sortLaptops(int range1, int range2) {
        modelList.clear();
        try {
