...
public class LatestLaptops extends ActionBarActivity {
    private static final String TAG = MainActivity.class.getSimpleName();

    // Movies json url
    private static final String url = "http://softtech.comuv.com/buyathome/new_laptops.js";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolBarTextView.setText("Latest Laptops");
    ...
    private void requestLaptops() {
       /* InnerGridView gridView = (InnerGridView) findViewById(R.id.grid2);
        adapter = new NewGridAdapter(this, modelList);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
               ...
               *//* bitmap = ((Model) modelList.get(position)).getThumbnailUrl();*//*
                ...
                Intent intent = new Intent(LatestLaptops.this, Details.class);
    ...
    private void serverDialog() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(LatestLaptops.this);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_latest_laptops, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_search) {
            Intent i = new Intent(LatestLaptops.this, SearchActivity.class);
            startActivity(i);
        }
