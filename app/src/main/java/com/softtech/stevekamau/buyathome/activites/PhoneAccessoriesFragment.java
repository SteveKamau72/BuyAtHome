 ...
 */
public class PhoneAccessoriesFragment extends Fragment implements OnOptionsSelectedInterface {
    ...
    public PhoneAccessoriesFragment() {
    ...
    private void loadPhonesAccessories(String data) {
        modelList.clear();
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                try {
                    ...
                    if (p_tags.contains("phone_accessory")) {
